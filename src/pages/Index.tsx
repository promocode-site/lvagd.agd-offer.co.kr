...
const coupons = [
  {
    ...
    expiry: "예약 ~2026.08.31 / 숙박 ~2027.06.30",
    category: "전 세계",
    minOrder: "USD 결제 기준",
    isHot: true,
  ...
  },
  {
    ...
    expiry: "예약 2026.08.01~08.31 / 숙박 ~2027.03.31",
    category: "해외전용",
    minOrder: "최대 $30 한도",
    isHot: true,
  },
...
const cardPromotions = [
  ...
  },
  {
    ...
    period: "예약 2026.08.01~08.31 / 투숙 2026.08.01~10.30",
    condition: "네이버페이 전용 프로모션 페이지에서 결제",
    note: "모바일 결제 시 8만원 이상 1,000P·20만원 이상 3,000P 적립",
  ...
  },
  {
    ...
    note: "계좌·카드 12만원 이상 3천원·30만원 이상 4천원, 삼성카드 20만원 이상 2천원 추가할인",
...
const regularPromos = [
  ...
  },
  {
    ...
    discount: "최대 25%",
    region: "체크인 90일 이전 예약 시 (2026.08.31까지)",
  },
];
...
const Index = () => {
  const schemaOrg = {
    ...
    description: "8월 아고다 할인쿠폰 총정리! 국내 여행, 일본 여행 전용 아고다 할인코드부터 카카오페이 할인 혜택, 전용 할인링크까지 한 번에. 지금 바로 쓸 수 있는 아고다 할인쿠폰 모음! 8월 최신 할인 정보를 확인해보세요.",
    potentialAction: {
      "@type": "SearchAction",
  ...
  const offerSchema = {
    ...
    "@type": "ItemList",
    name: "아고다 할인코드 목록",
    description: "2026년 8월 기준 아고다 공식 할인코드 및 쿠폰, 프로모션 코드 모음",
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-20 md:py-32 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6 text-primary-foreground/80 text-sm">
            ...
            <span className="flex items-center gap-1"><Clock className="h-4 w-4" /> 2026년 8월 기준</span>
      ...
      <section id="coupons" className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">🎟️ 2026년 8월 사용 가능한 공식 할인코드</h2>
      ...
      <section className="bg-muted py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-foreground text-center mb-4">💳 카드사 제휴 프로모션 (2026년 8월)</h2>
