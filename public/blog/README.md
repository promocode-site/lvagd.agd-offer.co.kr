# 블로그 폴더 설명 (lvagd.agd-offer.co.kr)
...
주소는 `https://lvagd.agd-offer.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://lvagd.agd-offer.co.kr/blog/agoda-coupon/ |
...
- 포인트 색: **#3182F6** (toss-blue) — `blog.css` 맨 위 `--blog-point`
